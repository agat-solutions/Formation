...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="Exploitant"/>
    <edittype labelontop="0" editable="1" type="0" name="NOM"/>
    <edittype labelontop="0" editable="1" type="0" name="NUMERO"/>
    <edittype labelontop="0" editable="1" type="0" name="traité"/>
  </edittypes>
  <editform>.</editform>
